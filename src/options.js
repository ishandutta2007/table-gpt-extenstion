...
! function(e) {
    ...
    function a(e) {
        return e.to = "background", f.callChromeAsync("runtime.sendMessage", e).then(function(e) {
            return {
                receiver: "background",
                data: e
            }
    ...
    function i(e, t) {
        return e.to = t, f.callChromeAsync("tabs.sendMessage", t.tabId, e, {
            frameId: t.frameId
        }).then(function(e) {
            return {
                receiver: t,
    ...
    u.enumFrames = function(e) {
        function t(e) {
            return f.callChromeAsync("webNavigation.getAllFrames", {
                tabId: e.id
            }).then(function(t) {
                return t || (t = [{
                    errorOccurred: !1,
        ...
        return "active" === e && (e = {
            active: !0,
            currentWindow: !0
        }), f.callChromeAsync("tabs.query", e || {}).then(function(e) {
        ...
        f.callChrome("runtime.onMessage.addListener", function(t, n, r) {
            if (e[t.name]) {
                t.sender = o(n);
                return r(e[t.name](t))
            }
    ...
    var i = e.exports = {},
        ...
        f = n(4),
        l = c.modifiers.ALT,
        m = c.mac ? c.modifiers.META : c.modifiers.CTRL,
        s = {
            "modifier.cell": l,
            "modifier.column": l | m,
            "modifier.row": 0,
        ...
        v = {};
    i.load = function() {
        return f.callChromeAsync("storage.local.get", null).then(function(e) {
            return e = e || {}, "modKey" in e && "1" === String(e.modKey) && (e["modifier.cell"] = m, delete e.modKey), v = Object.assign({}, s, v, e), v["scroll.amount"] = a(1, v["scroll.amount"], 100), v["scroll.acceleration"] = a(0, v["scroll.acceleration"], 100), v["number.group"] || (v["number.group"] = u.defaultFormat().group), v["number.decimal"] || (v["number.decimal"] = u.defaultFormat().decimal), v
        })
    }, i.save = function() {
        return f.callChromeAsync("storage.local.clear").then(function() {
            return f.callChromeAsync("storage.local.set", v)
        }).then(function() {
            return v
        })
    }, i.setAll = function(e) {
        return v = Object.assign({}, v, e), i.save()
    }, i.set = function(e, t) {
        return v[e] = t, i.save()
    }, i.val = function(e) {
        return v[e]
    ...
    n.mac = navigator.userAgent.indexOf("Macintosh") > 0, n.win = navigator.userAgent.indexOf("Windows") > 0, n.modifiers = {
        ...
        return a && (c.modifiers = {
            code: t,
            name: a
        }, i.push(a)), o && (c.scan = {
            code: r,
            name: o
        }, i.push(o)), c.code = t | r, c.name = i.join(" "), c
    }
}, function(e, t) {
    function n(e) {
        return e.match(/^\d+$/)
    ...
    function r(e) {
        var t = ['<label class="sticky">', '   <input type="checkbox" ${checked} data-modifier="${code}" data-mode="${mode}">', "   <span>${name}</span>", "</label>"].join(""),
            n = u.val("modifier." + e);
        return f.mouseModifiers.map(function(r) {
            return s.format(t, {
                code: r,
                name: f.modHTMLNames[r],
                mode: e,
                checked: n & r ? "checked" : ""
            })
        }).join("")
    ...
    function o() {
        var e = ["<tr>", "   <td><b>${name}</b><i>${desc}</i></td>", '   <td><label class="cb">', '       <input type="checkbox" data-bool="copy.format.enabled.${id}"><span>Enabled</span>   </label></td>', '   <td><label class="sticky">', '       <input type="radio" name="defaultFormat" data-bool="copy.format.default.${id}"><span>Default</span>', "   </label></td>", "</tr>"].join("");
        return "<table>" + u.copyFormats().map(function(t) {
            return s.format(e, t)
        }).join("") + "</table>"
    }

    function a() {
        c.findOne("#copy-formats").innerHTML = o(), c.find("[data-modifiers]").forEach(function(e) {
            e.innerHTML = r(c.attr(e, "data-modifiers"))
        }), c.find("[data-bool]").forEach(function(e) {
            e.checked = !!u.val(c.attr(e, "data-bool"))
        }), c.find("[data-select]").forEach(function(e) {
            e.checked = u.val(c.attr(e, "data-select")) === c.attr(e, "data-select-value")
        }), c.find("[data-text]").forEach(function(e) {
            var t = u.val(c.attr(e, "data-text"));
            e.value = void 0 === t ? "" : t
        })
    }
    ...
    function i() {
        var e = {};
        c.find("[data-modifier]").forEach(function(t) {
            var n = Number(c.attr(t, "data-modifier")),
                r = c.attr(t, "data-mode");
            e["modifier." + r] = (e["modifier." + r] || 0) | (t.checked ? n : 0)
        }), c.find("[data-bool]").forEach(function(t) {
            e[c.attr(t, "data-bool")] = !!t.checked
        }), c.find("[data-select]").forEach(function(t) {
            t.checked && (e[c.attr(t, "data-select")] = c.attr(t, "data-select-value"))
        }), c.find("[data-text]").forEach(function(t) {
            e[c.attr(t, "data-text")] = t.value
        }), u.setAll(e).then(a), m.background("preferencesUpdated")
    }
    var c = n(12),
        u = n(5),
        f = n(6),
    ...
    window.onload = function() {
        u.load().then(a), l.listen(window, {
            input: i,
            change: i,
            click: function(e) {
                var t = c.attr(e.target, "data-command");
                t && (m.background({
                    name: "command",
                    command: t
                }), l.reset(e))
